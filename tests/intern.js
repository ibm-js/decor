...
define({
	...
	environments: [
		...
		{ browserName: "firefox", version: "28", platform: "Windows 7", name : "decor" },
		{ browserName: "chrome", version: "33", platform: "Windows 7", name : "decor" },
		{ browserName: "safari", version: "7", platform: "OS X 10.9", name : "decor" },

		// Mobile
		{ browserName: "iphone", platform: "OS X 10.9", version: "7", name : "decor"}
	...
	excludeInstrumentation: /dcl|dojo|node_modules|requirejs|tests/
});
